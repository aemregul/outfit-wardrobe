...
export function PostDetailScreen() {
  ...
  const isOwner = !!me && !!post && me.id === post.userId;
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.container}>
          ...
          <View style={styles.reactRow}>
            ...
            >
              ...
              <Text style={[
                styles.reactCount,
                post.likedByCurrentUser && styles.reactCountActive,
              ]}>
          ...
          {comments.map((c) => (
            <View key={c.id} style={styles.commentRow}>
              <TouchableOpacity
                style={styles.commentAuthorArea}
...
const styles = StyleSheet.create({
  root: { flex: 1 },
  scroll: { flex: 1 },
  container: { padding: 24, maxWidth: 640, width: '100%' },
  ...
  deletePostBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6, borderWidth: 1, borderColor: '#FCA5A5' },
  ...
  outfitBtn: {
    backgroundColor: '#EDE9FE', paddingVertical: 10,
  ...
  reactRow: {
    ...
    borderColor: '#F3F4F6', paddingVertical: 12, marginBottom: 20,
  },
  ...
  commentAuthorArea: { flexShrink: 0 },
  commentAvatar: {
