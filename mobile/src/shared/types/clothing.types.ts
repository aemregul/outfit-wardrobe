...
export const CLOTHING_SEASON_LABELS: Record<ClothingSeason, string> = {
  ...
  WINTER: 'Kış', ALL_SEASON: 'Tüm Mevsimler',
};
...
export const CLOTHING_STYLE_LABELS: Record<ClothingStyle, string> = {
  CASUAL: 'Günlük', FORMAL: 'Resmi', BUSINESS: 'İş', SPORT: 'Spor',
  STREETWEAR: 'Sokak', CHIC: 'Şık', MINIMAL: 'Minimal', VINTAGE: 'Vintage',
  ELEGANT: 'Zarif', PARTY: 'Parti', TRAVEL: 'Seyahat', HOME: 'Ev',
};
